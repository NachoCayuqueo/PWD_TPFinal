...
<body>
    ...
    ?>
    <script>
        var datosProducto = <?php echo json_encode($datos); ?>;
    </script>

    <script src="<?php echo $PUBLIC_JS ?>/deposit/modifyProductAjax.js">
    ...
    <div class="main-container">
        <div class="container mt-3 mb-3">
            <div class="card ">
                ...
                <div>
                    <form class="form card-body card-title text" id="form-modificar-producto" name="form-modif-producto" novalidate enctype="multipart/form-data">
                        <div class="row mb-4">
                            <div class="col">
                                <label for="nombre" class="form-label">Nombre</label>
                                <input id="nombre" name="nombre" class="form-control" type="text" required>
                                <div class=" invalid-feedback">Debe ingresar el nombre
                                </div>
                            </div>
                            <div class="col">
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <input id="stock" name="stock" class="form-control" value=0 type="number">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                ...
                                <input id="idProducto" name="idProducto" class="form-control" type="text" readonly>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col">
                        ...
                        <div class="row mb-4">
                            <div class="col text-center border">
                                <h6>Imagen actual</h6>
                                <img alt="" width="300" height="300" id="imagen">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-4">
                            <button id='btn-send' class="btn btn-text btn-color me-md-2" type="submit">Modificar</button>
